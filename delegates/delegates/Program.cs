...
namespace assignment8ex1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            songDelegate fullSong = new songDelegate(HereComesTheSun.chorus);
            fullSong += HereComesTheSun.verse1;
            fullSong+= HereComesTheSun.chorus;
            fullSong+= HereComesTheSun.verse2;
            fullSong += HereComesTheSun.chorus2;
            fullSong+= HereComesTheSun.verse3;
            fullSong += HereComesTheSun.chorus;
            fullSong += HereComesTheSun.chorus;
            fullSong += HereComesTheSun.end;
            fullSong();
        }
    }
}
